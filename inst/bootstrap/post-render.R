# docstyle post-render bootstrap
# Auto-restores _extensions/docstyle/ if missing, then runs the real post-render script.
...
source(file.path(ext_dir, "update-field-codes.R"), local = TRUE)
